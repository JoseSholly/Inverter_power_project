...
class SizingModelTests(SimpleTestCase):
    ...
    def test_battery_count_is_series_times_parallel(self):
        self.assertEqual(sizing.number_of_batteries(450, 200, 12), 3)   # 1 in series x 3 strings
    ...
    def test_solar_array_and_currents(self):
        self.assertEqual(sizing.solar_array_capacity_wp(3420), 712.5)  # 3420 / (6 h x 0.8)
