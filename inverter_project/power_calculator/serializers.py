...
class CalculationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Calculation
        fields = ['id', 'created',"backup_time", 'total_load', 'inverter_rating',"battery_voltage","total_battery_capacity", "numbers_of_batteries", "battery_capacity", "total_solar_panel_capacity","numbers_of_solar_panel", "total_current"]
